...
(function(F) {
    ...
    function cb(a, b) {
        if (!y(a))
            return Q(b) || (b = b ? 2 : null), JSON.stringify(a, ce,
                b)
    }
                ...
                for (var p = -Number.MAX_VALUE, u = l.newScopeDirective, r = l.controllerDirectives, B = l.newIsolateScopeDirective, x = l.templateDirective, A = l.nonTlbTranscludeDirective, H = !1, z = !1, w = l.hasElementTranscludeDirective,
                    ...
                    if (v = t.transclude)
                        if (H = !0, t.$$tlb || (W("transclusion", A, t, N), A = t), "element" == v)
                            w = !0, p = t.priority, R = N, N = d.$$element = G(aa.$$createComment(M, d[M])), b = N[0], ca(f, ya.call(R, 0), b), R[0].$$parentNode = R[0].parentNode, ka = ac(va, R, e, p, g && g.name, {
                    ...
                    if (t.template)
                        if (z = !0, W("template", x, t, N), x = t, v = E(t.template) ? t.template(N, d) : t.template, v = ra(v), t.replace) {
                            ...
                            N.html(v);
                    if (t.templateUrl)
                        z = !0, W("template", x, t, N), x = t, t.replace && (g = t), n = Z(a.splice(C, a.length - C), N, d, f, H && ka, h, k, {
    ...
    function ff() {
        ...
        this.$get = ["$injector", "$window", function(d, c) {
            ...
            return function(f, g, h, k) {
                ...
                if (h)
                    return h = (K(f) ? f[f.length - 1] : f).prototype, l = Object.create(h || null), n && e(g, n, l, m || f.name), P(function() {
                                        ...
                                        try {
                                            if (a = p[r])
                                                if (m = a.get, (g = m(w)) !== (k = a.last) && !(a.eq ? na(g, k) : "number" === typeof g && "number" === typeof k && isNaN(g) && isNaN(k)))
                                                    x = !0, c = a, a.last = a.eq ? oa(g, null) : g, l = a.fn, l(g, k === s ? g : k, w), 5 > q && (C = 4 - q, y[C] || (y[C] = []), y[C].push({
                                                        msg: E(a.exp) ?
        ...
        this.$get = ["$templateCache", "$http", "$q", "$sce", function(b, d, c, e) {
            function f(g, h) {
                ...
                return d.get(g, P({
                    ...
                    if (!h)
                        throw og("tpload", g, a.status, a.statusText);
                    return c.reject(a)
                })
            }
        ...
        return function(e, f, g, h, k, l, m) {
            ...
            h.$formatters.push(function(a) {
                if (a && !ha(a))
                    throw nb("datefmt", a);
                if (n(a))
                    return (s = a) && q && (s = Tb(s, q, !0)), m("date")(a, c, q);
                s = null;
                return ""
            });
            if (v(g.min) || g.ngMin) {
            ...
            this.$$runValidators = function(a, b, c) {
                ...
                (function() {
                    ...
                    if (y(z))
                        ...
                        return z || (q(r.$validators, function(a, b) {
                            f(b, null)
                ...
                link: function(a,
                    ...
                    if (c) {
                        ...
                        d.$observe("pattern", function(a) {
                            ...
                            if (a && !a.test)
                                throw O("ngPattern")("noregexp", f, a, ua(b));
                            e = a || void 0;
                            c.$validate()
                        });
